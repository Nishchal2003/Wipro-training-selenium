...
Verify Ecomerce Application
        ...
        Wait Until Element Is Visible    //a[contains(text(),'Test Cases')]
        Click Element    //a[contains(text(),'Test Cases')]
        Wait Until Element Is Visible    //b[normalize-space()='Test Cases']
        Close Browser
